...
PROTOBUF_NAMESPACE_OPEN
template<> ::mprpcs::RpcHeader* Arena::CreateMaybeMessage<::mprpcs::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace mprpcs {
...
class RpcHeader :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mprpcs.RpcHeader) */ {
 public:
  RpcHeader();
  virtual ~RpcHeader();
  ...
  enum : int {
    kServicerNameFieldNumber = 1,
    kMethodNameFieldNumber = 2,
    kArgsSizeFieldNumber = 3,
  };
  // bytes servicer_name = 1;
  void clear_servicer_name();
  const std::string& servicer_name() const;
  void set_servicer_name(const std::string& value);
  void set_servicer_name(std::string&& value);
  void set_servicer_name(const char* value);
  void set_servicer_name(const void* value, size_t size);
  std::string* mutable_servicer_name();
  std::string* release_servicer_name();
  void set_allocated_servicer_name(std::string* servicer_name);
  private:
  const std::string& _internal_servicer_name() const;
  void _internal_set_servicer_name(const std::string& value);
  std::string* _internal_mutable_servicer_name();
  public:
  ...
  // @@protoc_insertion_point(class_scope:mprpcs.RpcHeader)
 private:
  class _Internal;

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr servicer_name_;
...
// bytes servicer_name = 1;
inline void RpcHeader::clear_servicer_name() {
  servicer_name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RpcHeader::servicer_name() const {
  // @@protoc_insertion_point(field_get:mprpcs.RpcHeader.servicer_name)
  return _internal_servicer_name();
}
inline void RpcHeader::set_servicer_name(const std::string& value) {
  _internal_set_servicer_name(value);
  // @@protoc_insertion_point(field_set:mprpcs.RpcHeader.servicer_name)
}
inline std::string* RpcHeader::mutable_servicer_name() {
  // @@protoc_insertion_point(field_mutable:mprpcs.RpcHeader.servicer_name)
  return _internal_mutable_servicer_name();
}
inline const std::string& RpcHeader::_internal_servicer_name() const {
  return servicer_name_.GetNoArena();
}
inline void RpcHeader::_internal_set_servicer_name(const std::string& value) {
  
  servicer_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void RpcHeader::set_servicer_name(std::string&& value) {
  
  servicer_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mprpcs.RpcHeader.servicer_name)
}
inline void RpcHeader::set_servicer_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  servicer_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mprpcs.RpcHeader.servicer_name)
}
inline void RpcHeader::set_servicer_name(const void* value, size_t size) {
  
  servicer_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mprpcs.RpcHeader.servicer_name)
}
inline std::string* RpcHeader::_internal_mutable_servicer_name() {
  
  return servicer_name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RpcHeader::release_servicer_name() {
  // @@protoc_insertion_point(field_release:mprpcs.RpcHeader.servicer_name)
  
  return servicer_name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RpcHeader::set_allocated_servicer_name(std::string* servicer_name) {
  if (servicer_name != nullptr) {
    
  } else {
    
  }
  servicer_name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), servicer_name);
  // @@protoc_insertion_point(field_set_allocated:mprpcs.RpcHeader.servicer_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:mprpcs.RpcHeader.method_name)
  return _internal_method_name();
}
inline void RpcHeader::set_method_name(const std::string& value) {
  _internal_set_method_name(value);
  // @@protoc_insertion_point(field_set:mprpcs.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  // @@protoc_insertion_point(field_mutable:mprpcs.RpcHeader.method_name)
...
inline void RpcHeader::set_method_name(std::string&& value) {
  ...
  method_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mprpcs.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:mprpcs.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const void* value, size_t size) {
  ...
  method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mprpcs.RpcHeader.method_name)
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:mprpcs.RpcHeader.method_name)
...
inline void RpcHeader::set_allocated_method_name(std::string* method_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mprpcs.RpcHeader.method_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:mprpcs.RpcHeader.args_size)
...
inline void RpcHeader::set_args_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:mprpcs.RpcHeader.args_size)
}
