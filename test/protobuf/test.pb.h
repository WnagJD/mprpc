...
inline ::mprpc::User* GetFriendListsResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:mprpc.GetFriendListsResponse.friend_list)
...
GetFriendListsResponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:mprpc.GetFriendListsResponse.friend_list)
  return &friend_list_;
}
inline const ::mprpc::User& GetFriendListsResponse::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::mprpc::User& GetFriendListsResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:mprpc.GetFriendListsResponse.friend_list)
  return _internal_friend_list(index);
}
inline ::mprpc::User* GetFriendListsResponse::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::mprpc::User* GetFriendListsResponse::add_friend_list() {
  // @@protoc_insertion_point(field_add:mprpc.GetFriendListsResponse.friend_list)
...
GetFriendListsResponse::friend_list() const {
  // @@protoc_insertion_point(field_list:mprpc.GetFriendListsResponse.friend_list)
  return friend_list_;
}
